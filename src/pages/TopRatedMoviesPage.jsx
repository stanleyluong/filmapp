            ...
            <Table size="small">
              ...
              <TableBody>
                {sortedMovies.map(movie => {
                  const posterUrl = movie.poster_path ? getImageUrl(movie.poster_path, 'w92') : '/500x750.png';
                  ...
                  return (
                    ...
                    >
                      <TableCell>
                        <Avatar variant="rounded" src={posterUrl} alt={movie.title} sx={{ width: 40, height: 60, bgcolor: 'grey.200' }} />
                      </TableCell>
                      <TableCell>{movie.title}</TableCell>
                      <TableCell>{year}</TableCell>
                      <TableCell>{movie.vote_average ? movie.vote_average.toFixed(1) : 'N/A'}</TableCell>
                      <TableCell>{movie.overview ? movie.overview.substring(0, 100) + (movie.overview.length > 100 ? '...' : '') : ''}</TableCell>
                    </TableRow>
                  );
                })}
              </TableBody>
